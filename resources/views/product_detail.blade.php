...
@section("contenido")
	...
	<div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-30 p-l-15-sm">
		<a href="{{ url('/' . $page='home') }}" class="s-text16">
			Home
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>

		<a href="{{ url('/' . $page='productos') }}" class="s-text16">
			Productos
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>
		...
		<div class="flex-w flex-sb">
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="p-b-45">
					...
					<span class="s-text8">Categorias: Tecnologia, Hogar</span>
				</div>
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							...
							<div class="block2-txt p-t-20">
								<a href="{{ url('/' . $page='product/20') }}" class="block2-name dis-block s-text3 p-b-5">
